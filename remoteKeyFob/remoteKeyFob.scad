...
wi=26;	// inner width, length & heigth
li=47;
h=7;
th=2;	// wall thickness
...
module buttonHoles() {
    buttonLength=8.2;
    buttonWidth=11.8;
    translate([0,0,-th*2]) color([0,0,1]) cube([buttonLength,buttonWidth,th*2]);
    translate([-(1.8+buttonLength),0,-th*2]) color([0,0,1]) cube([buttonLength,buttonWidth,th*2]);
    translate([-(1.8+buttonLength),-(buttonWidth+1.8),-th*2]) color([0,0,1]) cube([buttonLength,buttonWidth,th*2]);
    translate([0,-(buttonWidth+1.8),-th*2]) color([0,0,1]) cube([buttonLength,buttonWidth,th*2]);
}
    

difference() {
  box();
  translate([(1.8/2),-4,0]) buttonHoles();
}
