 ...
 difference() {
    cylinder(h=20, r=35);
    translate([0,0,-2]) cylinder(h=30, r=34, $fn=100);
 }
...
pr=20;
//moucharabieh(l=size);
    //rotate(180) moucharabieh(l=size);
//    translate([0,0,1.5*pr]) rotate([0,90,0]) moucharabieh(l=size);
    //translate([0,0,1.5*pr]) rotate([0,90,0]) moucharabieh(l=size);
  //  translate([0,0,-1.5*pr]) rotate([0,90,0]) moucharabieh(l=size);
    //translate([0,0,-1.5*pr]) rotate(270) moucharabieh(l=size);
